...
const globalStyle = {
  ...
  navigationBarBackgroundColor: "#178764",
...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.0.38"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilder/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"second","spaceId":"mp-54a00d6e-d94e-4ff4-bb85-16abde80adcb","clientSecret":"I58U/eYwdtIliGigldbWYA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__E2F2C68";
} catch (e2) {
